...
# curl -s -L "https://raw.githubusercontent.com/bigbinary/Citly/master/.scripts/sync_with_Citly.sh" | bash
...
raw_base_url="https://raw.githubusercontent.com/bigbinary/Citly/master"
declare -a configs=(
  ".eslintrc.js"
  ".eslintignore"
